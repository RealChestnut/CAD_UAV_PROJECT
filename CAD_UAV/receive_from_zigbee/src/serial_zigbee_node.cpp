...
int main (int argc, char** argv){
    ...
    ros::Publisher command_from_zigbee = nh.advertise<std_msgs::Float32MultiArray>("zigbee_command", 1);
	 ...
	 ////////////// parsing from complete data to std_msgs   /////////////////////
		...
		if(last_dump.size()==topic_num){
			...
			for(int i =0;i<last_dump.size();i++)
			{
				...
				//result.data = (isAppraoch, isDock, isManipul)
			}
			command_from_zigbee.publish(result);
		}
	/////////////////////////////////////////////////////////////////////// 		
	    last_dump.clear();
		}
