...
#include "CAD_UAV/ArmService.h" //ASDF
#include "CAD_UAV/KillService.h" //ASDF
#include "CAD_UAV/PosCtrlService.h" //ASDF
#include "CAD_UAV/HoverService.h" //ASDF
#include "CAD_UAV/FAC_HoverService.h" //ASDF
