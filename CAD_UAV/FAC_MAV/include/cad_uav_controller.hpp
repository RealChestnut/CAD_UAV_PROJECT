...
double altitude_limit = 0.5;// z direction limit (m)
...
void reset_data()
{
  ...
  XYZ_desired_base.x=main_position_opti_new.x;
  XYZ_desired_base.y=main_position_opti_new.y;
  XYZ_desired_base.z=main_position_opti_new.z;
