...
double Jyy = 3.20;//2.30;//1.12;//0.56;//0.56;//0.71;//0.208;//1.23;//1.71;
...
double tau_y_limit = 0.35; // yaw torque limit
double tau_y_th_limit = 6.0; // yaw torque w.r.t. servo tilt limit
...
void wrench_allocation()
{
  ...
  send_data_for_sub.data = data_2_string(F_xyzd_sub1.x,F_xyzd_sub1.y,F_xyzd_sub1.z, tau_r, tau_p, tau_y,kill_mode);
  }
