#include "cad_uav_util_function_2.hpp"
...
geometry_msgs::Vector3 rpy_dot_desired; // desired rpy angular velocity
...
double e_r_dot_i=0; //roll dot error integration
double e_p_dot_i=0; //pitch dot error integration
double e_y_dot_i=0; //yaw dot error integration
...
ros::Publisher angular_velocity; //REVISE
ros::Publisher desired_angular_velocity; // desired angular velocity data logging //REVISE
