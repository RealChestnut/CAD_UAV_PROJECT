...
double pwm_freq=417.3;//pwm signal frequency main :: 406.5  || sub :: 408.6
...
double switch_servo){
	...
	servo_msg.name.resize(1);
	servo_msg.name[0]="id_31";
	...
	servo_msg.position.resize(1);
	servo_msg.position[0]=switch_servo;
